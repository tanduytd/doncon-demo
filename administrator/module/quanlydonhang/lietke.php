...
<td>
    <?php if($row['cart_status']==1){
           echo '<a href="module/quanlydonhang/xuly.php?code='.$row['code_cart'].'">Chưa Liên Hệ</a>';
    }else{
        echo'Đã Liên Hệ';
    }?>
</td>
...
<td>
    <a href="index.php?action=donhang&query=xemdonhang&code=<?php echo $row['code_cart']?>">Xem Chi Tiết</a> 
</td>
